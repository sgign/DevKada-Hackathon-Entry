    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="w-full max-w-sm bg-[#F5DEB3] border-4 border-[#8D6E63] rounded-2xl shadow-[8px_8px_0_0_#6D4C41]">
        ...
        <div className="bg-[#A8D5BA] px-6 py-4 border-b-4 border-[#8D6E63] rounded-t-xl flex items-center justify-between">
          <h2 className="font-['VCR_OSD_Mono'] text-[10px] text-[#3E2723]">
            FEED PIG: {goalName}
          </h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-white border-4 border-[#8D6E63] rounded-lg px-4 py-3 text-[#3E2723] focus:outline-none focus:border-[#D2691E] shadow-[4px_4px_0_0_#6D4C41] font-['VCR_OSD_Mono'] text-[10px]"
            >
              {wallets.map((w) => (
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 bg-[#E8D5B7] hover:bg-[#D4B896] border-4 border-[#8D6E63] rounded-lg py-3 font-['VCR_OSD_Mono'] text-[8px] text-[#3E2723] shadow-[3px_3px_0_0_#6D4C41] active:shadow-[1px_1px_0_0_#6D4C41] active:translate-x-[2px] active:translate-y-[2px] transition-all"
            >
              CANCEL
            </button>
            <button
              type="submit"
              className="flex-1 bg-[#FFD966] hover:bg-[#FFD966]/80 border-4 border-[#3E2723] rounded-lg py-3 font-['VCR_OSD_Mono'] text-[8px] text-[#3E2723] shadow-[3px_3px_0_0_#6D4C41] active:shadow-[1px_1px_0_0_#6D4C41] active:translate-x-[2px] active:translate-y-[2px] transition-all"
            >
              ADD MONEY
            </button>
          </div>
